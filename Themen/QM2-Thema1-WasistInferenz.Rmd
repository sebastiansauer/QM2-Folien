...
\includegraphics[width=1em]{../img/weight.pdf} *Predictive Maintenance* ist ein Anwendungsfeld inferenzstatistische Modellierung. Lesen Sie dazu S. 3 [dieses Berichts](https://www.rolandberger.com/publications/publication_pdf/roland_berger_vdma_predictive_maintenance_d_1.pdf)!
...
\includegraphics[width=1em]{../img/weight.pdf} Nennen Sie ein weiteres Zufallsexperiment und formalisieren Sie anhand der obigen Begriffe!
