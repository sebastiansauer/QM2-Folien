...
Zwei Ereignisse sind *unabhängig*, wenn Kenntnis des einen uns keine Information gibt, ob das andere der Fall ist.
...
$Pr(A|H)$ ist die Wahrscheinlichkeit, dass $A$ eintritt, *gegeben* bzw. *unter der Bedingung*, dass $H$ eingetreten ist bzw. wir davon ausgehen.
...
$Pr(B) = 48/78 \qquad Pr(l) = 42/78$

$Pr(B|l) = 36/42 \approx 0.86 \qquad Pr(l|B) = 42/48 \approx 0.88$
...
$Pr(B \cap l) = 36/78 \approx 0.46 \qquad Pr(l) = 42/78 \approx 0.54$

$Pr(B|l)\approx \frac{0.46}{0.54} \approx 0.85$



## Visualierung zur Wahrscheinlichkeit
