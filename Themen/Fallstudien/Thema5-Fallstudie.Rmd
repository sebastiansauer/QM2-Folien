...
Nach langem Beratschschlagen mit Film-Experten gehen wir davon aus, dass es im Prinzip - "normalerweise" keinen Zusammenhang gibt. 
...
Mit anderen Worten, verzehnfacht man das Budget, 
erwarten wir eine Veränderung von (in 95% der Fälle) nicht mehr als ±0.4 Rating-Punkte.
...
Zuerst wandeln wir das Objekt `post2` in eine Tabele mit den Stichproben aus der Post-Verteilung um:
