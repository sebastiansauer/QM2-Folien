...
```{r QM2-Thema3-Post-befragen-5, echo = TRUE, out.width="70%", fig.align="center"}
d %>% 
...
.pull-right[
```{r QM2-Thema3-Post-befragen-10, ref.label= "plot2", echo = FALSE}
...
```{r QM2-Thema3-Post-befragen-35, fig.asp = .8, out.width="90%", eval = FALSE}
...
```{r QM2-Thema3-Post-befragen-39, results='asis', echo=FALSE}
