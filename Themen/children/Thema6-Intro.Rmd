...
## Datenlage spricht zugunsten der Covid19-Impfung
...
`r RefManageR::Citet(bib, "thompson_effectiveness_2021", .opts = list(max.names = 3, longnamesfirst = FALSE))`; vgl. auch `r RefManageR::Citet(bib, "nasreen_effectiveness_2021", .opts = list(max.names = 3, longnamesfirst = FALSE))`, `r RefManageR::Citet(bib, "pormohammad_efficacy_2021")`



Zwei Anforderungen an die Qualität von Studien:
...
`r RefManageR::Citet(bib, "dai_behavioural_2021")`
