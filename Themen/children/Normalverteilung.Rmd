...
In Summe liegen 100$ Wahrscheinlichkeitsmasse unter der Kurve.
...
- Anders gesagt: Welcher Anteil der Wahrscheinlichkeitsmasser der Verteilung liegt unter IQ=75, IQ=100, etc.?
...
.pull-right[
```{r exp1-plot, ref.label = "exp1", eval = TRUE}
