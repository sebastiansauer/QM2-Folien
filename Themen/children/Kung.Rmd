...
🤔 Sehr große Buschleute? `r round(anteil_großer_kung$prop[2], 2)*100` Prozent sind größer als 2 Meter. Das ist diskutabel, muss aber kein schlechter Prior sein.
]
...
ggMarginal(p_m41_post, type = "density")
```
...
.pull-right[
```{r Kung-17-bis, ref.label="m41-post-plot", fig.asp = 0.5, echo = FALSE}
