...
$$\text{log}_b(1)=0,\quad \text{log}_b(b)=1, \quad b^{\text{log_b(a)}=a},\quad  \text{log}_b(b^a)=a$$
...
### Definition
Die Wahrscheinlichkeit $p$ quantifiziert Ungewissheit im Hinblick auf eine Aussage $A$, gegeben eines Hintergrundwissen $H$. $p=0$ heißt, wir halten die Ausage für falsch; $p=1$ heißt, wir halten die Aussage für richtig. $0<p<1$ heißt, wir sind (mehr oder weniger) unsicher bzgl. der Aussage.
...
- A: "Schorsch, das rosa Einhort, mag Bier."; H: "50% der rosa Einhörner mögen Bier." $\implies (pA|H) = 1/2$.
